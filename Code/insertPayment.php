...
$sql = "INSERT INTO `bill`(`billid`, `grandtotal`, `datetime`, `paymentmethod`, `city`, `zipcode`, `address`, `remarks`,`status`, `trackingid`, `companyname`, `trackingurl`, `trackremarks`, `personreceived`, `returnremarks`, `email`) 
...
foreach ($ar as $item) {
    ...
    $s = "INSERT INTO `bill_details`(`id`, `price`, `discount`, `netprice`, `quantity`, `productid`, `billid`) 
